...
- **Dashboard** — headline 12-month-average figures (average monthly savings, true lifestyle, and core/min over your last 12 non-zero months), plus charts for cumulative cash saved, income vs spend, rolling savings ratio, expenditure-by-tier, min-vs-true-lifestyle-vs-actual, and budget-vs-actual by category.
